...
function updateBackButton(webview) {
  if (webview.canGoBack()) {
    if (!$("#back").hasClass("hover-style")) {
      $("#back").addClass("hover-style");
    }
  } else {
    $("#back").removeClass("hover-style");
  }
}
...
},{"./chrome-tabs.js":2,"./history-db.js":3,"fs":undefined,"jquery":10,"path":undefined,"unused-filename":14,"url":undefined}],2:[function(require,module,exports){
...
},{"electron":7}],5:[function(require,module,exports){
/*
